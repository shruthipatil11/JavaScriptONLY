...
Function along with its lexical scope(refernce to parent) forms a closure.As soon as I write a program, there n then itself reference or lexical scope is attached to it.
