...
| Error Type     | When It Happens               | Phase   | Meaning        |
| -------------- | ----------------------------- | ------- | -------------- |
| ReferenceError | Variable not found            | Runtime | Doesn’t exist  |
| TypeError      | Wrong usage of existing value | Runtime | Misuse of type |
| SyntaxError    | Invalid JS grammar            | Parsing | Code invalid   |

| Situation                         | Error          |
| --------------------------------- | -------------- |
| Variable not declared             | ReferenceError |
| Access before let init (TDZ)      | ReferenceError |
| Calling non-function              | TypeError      |
| Access property on null/undefined | TypeError      |
| Invalid JS grammar                | SyntaxError    |
